...
import { Shield, Mail, Lock, User, Check } from 'lucide-react-native';
          ...
          <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
            <View style={styles.header}>
              ...
              <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
                Create your account to begin your detox journey.
              </Text>
            </View>
              ...
              <View style={styles.inputContainer}>
                ...
                <TextInput
                  style={[
                    ...
                    {
                      color: colors.text,
                      borderColor: errors.fullName ? '#F87171' : colors.border,
                    },
                  ]}
